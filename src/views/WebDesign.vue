<template>
  <div>
    ...
    />
    <ProjectList :project-list="webDesignProjects" />
...
provide("imgFileName", "web-design");

const { appDesignLink, graphicDesignLink } = inject("linksContent");
const linksCards = [appDesignLink, graphicDesignLink];
</script>
